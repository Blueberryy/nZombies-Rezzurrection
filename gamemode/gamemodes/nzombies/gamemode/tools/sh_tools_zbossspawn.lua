nzTools:CreateTool("zbossspawn", {
	displayname = translate.Get("boss_spawn_creator_tool"),
	desc = translate.Get("boss_spawn_creator_tool_tip"),
	...
	interface = function(frame, data)
		...
		text:SetText(translate.Get("boss_spawn_creator_tool_help"))
