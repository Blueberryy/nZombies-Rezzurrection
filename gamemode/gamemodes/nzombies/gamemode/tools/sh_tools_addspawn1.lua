nzTools:CreateTool("zaddspawn1", {
	displayname = translate.Get("additional_spawn_creator_tool"),
	desc = translate.Get("additional_spawn_creator_tool_tip"),
	...
	displayname = translate.Get("extra_zombie_spawn_creator_tool"),
	desc = translate.Get("extra_zombie_spawn_creator_tool_tip"),
	...
	interface = function(frame, data)
		...
		text:SetText(translate.Get("extra_zombie_spawn_creator_tool_help"))
