...
function nzQMenu:CreateToolsMenu( )
	...
	ToolPanel:SetTitle(translate.Get("tools_tool_list_title"))
	...
	local function RebuildToolInterface(id)
		...
		if nzTools.ToolData[id] then
			...
			if !IsValid(ToolData.interface) then
				...
				ToolData.interface:SetText(translate.Get("this_tool_does_not_have_any_properties"))
	...
	advanced:SetText(translate.Get("tools_advanced_mode_button"))
